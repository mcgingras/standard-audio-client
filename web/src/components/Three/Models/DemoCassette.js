...
export default function DemoCassette(props) {
  const group = useRef()
    ...
    <group ref={group} {...props} dispose={null}>
      ...
      >
        ...
        <mesh
          material={
            materials[
              '_cc8c22ba-787b-48a1-b224-064feabd3e3f_b0eb2ade-5ecf-43ff-9d5d-70d24e8e56c8'
            ]
          }
        ...
        <mesh
          ...
          geometry={
            nodes[
              'teeth_ring_outer_&_teeth_ring_hole_&_film_roll_left_&_film_roll_left_hole'
            ].geometry
          }
        ...
        <mesh
          ...
          geometry={
            nodes[
              'teeth_ring_outer_&_teeth_ring_hole_&_film_roll_left_&_film_roll_left_hole_1'
            ].geometry
          }
          material-color={props.colors['teeth_ring']}
        />
